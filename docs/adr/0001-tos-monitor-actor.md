...
- Related: [`com-junkawasaki/root` ADR-2607110300](https://github.com/com-junkawasaki/root/blob/main/90-docs/adr/2607110300-cloud-itonami-lei-corporate-tos-catalog.edn)
  ...
  P&G); [`com-junkawasaki/root` ADR-2607242300](https://github.com/com-junkawasaki/root/blob/main/90-docs/adr/2607242300-cloud-itonami-lei-tos-monitor-actor-batch10-round2.edn)
  (the round-2 10-repo validation batch this repo is part of).

## Context

This repository archives the publicly published legal/policy document of
AECOM, per ADR-2607110300 -- a read-only reference archive. As part of a
second 10-repo validation batch extending the
`cloud-itonami-lei-2572ibtt8cczw6au4141` pilot (see ADR-2607241900/
ADR-2607242000/ADR-2607242300 for the full fleet-level design rationale),
...
- **Company**: AECOM, LEI 0EEB8GF0W0NPCIHZX097, website
  `https://www.aecom.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.aecom.com/terms-use`,
  retrieved-at `2026-07-10T08:46:10Z`, doc-type `:terms-of-service`.
